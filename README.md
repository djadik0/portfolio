...
Начинающий инженер в направлении FPGA / RTL / SoC. Работаю лаборантом в НИЛ ЭСК НИУ МИЭТ по направлению RTL / цифровое проектирование.

Основной интерес — разработка SoC-систем и их верхнего уровня, interconnect-архитектура, проектирование и интеграция цифровых IP-блоков, а также разработка процессорных ядер.
