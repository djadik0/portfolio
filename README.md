...
- Выполнял аппаратную отладку RTL-дизайнов на FPGA с использованием Vivado ILA: анализировал внутренние сигналы, состояния FSM и интерфейсные обмены на реальной плате.
